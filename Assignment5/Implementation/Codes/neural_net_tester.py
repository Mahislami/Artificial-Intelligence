...
from neural_net import train, test, make_neural_net_basic,make_neural_net_two_layer, make_neural_net_two_moons \
...
def main(neural_net_func, data_sets, rate=1.0, max_iterations=10000):
    ...
    for name, training_data, test_data in data_sets:
        ...
        nn = neural_net_func()
        train(nn, training_data, rate=rate, max_iterations=max_iterations, verbose=verbose)
